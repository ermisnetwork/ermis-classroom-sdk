...
export interface ErmisClientConfig {
  ...
  debug?: boolean;
  /**
   * Video resolutions to publish. Default: [cam_360p] only.
   * To add 720p: [ChannelName.CAM_360P, ChannelName.CAM_720P]
   * To publish higher: [ChannelName.CAM_360P, ChannelName.CAM_1080P]
   */
