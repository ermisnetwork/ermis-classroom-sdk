 ...
 */
export function getFrameType(channelName, chunkType) {
    switch (channelName) {
 ...
 */
export function getTransportPacketType(frameType) {
    switch (frameType) {
 ...
 */
export function getDataChannelId(channelName, type = "camera") {
    const mapping = {
        camera: {
...
export function getSubStreams(streamType) {
